...
export const HeroCards = () => {
  ...
  return (
      <div className="flex flex-col lg:flex-row flex-wrap gap-8 relative w-full lg:w-[700px] h-auto lg:h-[500px]">
        ...
        {/* Testimonial */}
        <Card className="w-full lg:w-[340px] lg:absolute lg:-top-[15px] drop-shadow-xl shadow-black/10 dark:shadow-white/10">
        ...
        <Card className="w-full lg:w-72 drop-shadow-xl shadow-black/10 dark:shadow-white/10 lg:absolute lg:top-[150px] lg:left-[50px]">
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              ...
              <Badge variant="secondary" className="text-sm text-primary">Popüler</Badge>
            </CardTitle>
          </CardHeader>
